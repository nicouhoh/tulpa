...
public class Visipalp {
    ...
    void materialize(ArrayList<Clipping> clippings){
        contactSheet = new ContactSheet(this);
        System.out.println("Giving form to clippings");
        for (Clipping clip : clippings){
            contactSheet.children.add(new Thumbnail(g, getID(), clip, 0, 0, getClipSize(), getClipSize()));
        }
    }
